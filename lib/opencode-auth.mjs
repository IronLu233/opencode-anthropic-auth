 ...
 * @returns {{ refreshToken: string, access?: string, expires?: number, accountUuid?: string } | null}
 */
 ...
 * @param {{ refresh: string, access: string, expires: number, accountUuid?: string }} input
 */
export async function setOpenCodeAuth(input) {
  await withOpenCodeAuthLock(async () => {
    ...
    records[PROVIDER_ID] = {
      ...
      ...(typeof input.accountUuid === "string" ? { accountUuid: input.accountUuid } : {}),
 ...
 * @returns {Promise<{type: "oauth", refresh: string, access: string, expires: number, accountUuid?: string} | null>}
 */
export async function getOpenCodeAuth() {
  ...
  return {
    ...
    ...(typeof entry.accountUuid === "string" ? { accountUuid: entry.accountUuid } : {}),
  };
}
