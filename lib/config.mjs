...
function applyEnvOverrides(config) {
  ...
  if (process.env.OPENCODE_ANTHROPIC_DEBUG === "1" || process.env.OPENCODE_ANTHROPIC_DEBUG === "true") {
    next.debug = true;
  }
  if (process.env.OPENCODE_ANTHROPIC_DEBUG === "0" || process.env.OPENCODE_ANTHROPIC_DEBUG === "false") {
    next.debug = false;
  }
