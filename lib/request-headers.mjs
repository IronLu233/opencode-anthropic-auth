 ...
 * model with ISP, 1M context, redact-thinking, and task-budgets support.
 * @type {HeaderProfile}
 */
...
export const HEADER_PROFILES = {
  "claude-cli-default": CLAUDE_CLI_2_1_90_PROFILE,
...
export const DEFAULT_HEADER_PROFILE = "claude-cli-2.1.90";
