...
| Header profile   | Default profile `claude-cli-2.1.92` (alias `claude-cli-default`); `claude-cli-2.1.90` remains available as the only pinned compatibility alternative                                                                                                                                                                                       | Spoof separate Claude CLI client       |
| Beta headers     | `claude-cli-2.1.92` defaults (`claude-code-20250219`, `oauth-2025-04-20`, `context-1m-2025-08-07`, `interleaved-thinking-2025-05-14`, `redact-thinking-2026-02-12`, `prompt-caching-scope-2026-01-05`, `advanced-tool-use-2025-11-20`, `effort-2025-11-24`) + Opus-only `context-management-2025-06-27`, merged with incoming custom betas | Required beta features + compatibility |
